		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#SYNCzdcmmui5ekko-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SYNCzdcmmui5ekko-display": {
								"semanticObject": "SYNCzdcmmui5ekko",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SYNC.zdcmmui5ekko",
									"url": sap.ui.require.toUrl("SYNC/zdcmmui5ekko")
								}
							}
						}
					}
